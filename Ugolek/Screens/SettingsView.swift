        ...
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    Text("Случайные фразы — вместо одного текста Уголёк берёт короткую фразу из пула. Пропускать недоступных — если чат друга не нашёлся, прогон продолжится с остальными. «Только с огоньком» — письма уходят лишь друзьям с включённым флажком 🔥 (в веб-версии TikTok огонёк не отображается, поэтому он отмечается вручную у каждого друга).")
                }
